        ...
        <form action="{{route('admin.updatebranch',$branch->id)}}" method="POST" enctype="multipart/form-data">
          ...
          <div class="row mb-3">
            <div class="col-md-6">
              ...
              <input type="text" name="name" id="name" class="form-control" value="{{$branch->name}}" placeholder="Branch Name" required>
              @error('name')
            ...
            <div class="col-md-6">
              ...
              <input type="text" name="br_code" id="br_code" class="form-control" value="{{$branch->br_code}}" placeholder="ex# 00010"  required>
               @error('br_code')
              <span class="text-danger small">{{$message}}</span>
              @enderror
            </div>
